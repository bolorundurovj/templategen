    ...
    <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-8">
      ...
      <div className="text-center space-y-4 mb-12">
        ...
        <p className="text-lg md:text-xl text-slate-600 max-w-2xl mx-auto">
          You've successfully scaffolded a modern Next.js application. 
          Start editing <code className="bg-white border border-slate-200 text-teal-700 px-2 py-1 rounded font-mono text-sm">app/page.js</code> to see changes instantly.
        </p>
      </div>
