...
function App() {
  ...
  const [currentView, setCurrentView] = useState<'home' | 'items'>(() =>
        ...
        <>
          ...
          <div className="text-center space-y-4 mb-12 animate-fade-in-up">
            ...
            <p className="text-base sm:text-lg md:text-xl text-slate-600 dark:text-slate-300 max-w-2xl mx-auto">
              You've successfully scaffolded a modern React + TypeScript application with theming and responsive navigation. 
              Start editing <code className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-teal-700 dark:text-teal-300 px-2 py-1 rounded font-mono text-sm">src/App.tsx</code> to see changes instantly.
            </p>
          </div>
