    ...
    <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-8">
      ...
      <div className="text-center space-y-4 mb-12 animate-fade-in-up">
        ...
        <p className="text-lg md:text-xl text-slate-600 max-w-2xl mx-auto">
          You've successfully scaffolded a modern React + TypeScript application. 
          Start editing <code className="bg-white border border-slate-200 text-teal-700 px-2 py-1 rounded font-mono text-sm">src/App.tsx</code> to see changes instantly.
        </p>
      </div>
      ...
      <div className="relative p-8 bg-white border border-slate-200 rounded-xl shadow-sm flex flex-col items-center space-y-6 w-full max-w-md">
        <div className="flex items-center space-x-4 w-full justify-center">
          ...
          <div>
            ...
            <p className="text-slate-500 text-sm">Test out hot module replacement.</p>
          </div>
        </div>
        ...
        <div className="w-full pt-4 border-t border-slate-100 flex justify-center">
          ...
          <% } else { %>
          <button 
            className="px-6 py-3 bg-teal-600 text-white font-semibold rounded-md shadow-sm hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2 transition-colors w-full"
